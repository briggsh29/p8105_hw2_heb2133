...
The pols-month dataset contains information on the number of national politicians who are democratic or republican during the years `r range(pull(politicians_df))`. Variables include the date (month, year), whether the president was republican or democrat, and the number of democrat or republican govenors, senators, and representatives. There are `r nrow(politicians_df)` rows and `r ncol(politicians_df)` columns.
...
The resulting merged dataset from these data has `r nrow(final_538_df)` rows and `r ncol(final_538_df)` columns. Key variables include year; month; whether democrat or republican president; number of democratic and republican governors, senators, and representatives; closing values of S&P stock index; and percentage of unemployment. The range of years within this data set is `r range(pull(final_538_df, year))`. 
